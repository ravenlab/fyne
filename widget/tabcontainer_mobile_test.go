...
func TestTabContainer_ChangeItemContent(t *testing.T) {
	...
	test.AssertImageMatches(t, "tabcontainer/mobile/two_initial.png", c.Capture())

	item1.Content = widget.NewLabel("Text3")
	tabs.Refresh()
	test.AssertImageMatches(t, "tabcontainer/mobile/two_change_selected.png", c.Capture())

	item2.Content = widget.NewLabel("Text4")
	tabs.Refresh()
	test.AssertImageMatches(t, "tabcontainer/mobile/two_change_unselected.png", c.Capture())
}
...
func TestTabContainer_ChangeItemIcon(t *testing.T) {
	...
	test.AssertImageMatches(t, "tabcontainer/mobile/two_icons_initial.png", c.Capture())

	item1.Icon = theme.InfoIcon()
	tabs.Refresh()
	test.AssertImageMatches(t, "tabcontainer/mobile/two_icons_change_icon_selected.png", c.Capture())

	item2.Icon = theme.ContentAddIcon()
	tabs.Refresh()
	test.AssertImageMatches(t, "tabcontainer/mobile/two_icons_change_icon_unselected.png", c.Capture())
}
...
func TestTabContainer_ChangeItemText(t *testing.T) {
	...
	item1.Text = "New 1"
	tabs.Refresh()
	test.AssertImageMatches(t, "tabcontainer/mobile/two_change_tab_text_selected.png", c.Capture())

	item2.Text = "New 2"
	tabs.Refresh()
	test.AssertImageMatches(t, "tabcontainer/mobile/two_change_tab_text_unselected.png", c.Capture())
}
...
func TestTabContainer_DynamicTabs(t *testing.T) {
	...
	test.AssertImageMatches(t, "tabcontainer/mobile/dynamic_initial.png", c.Capture())
	...
	test.AssertImageMatches(t, "tabcontainer/mobile/dynamic_appended.png", c.Capture())
	...
	test.AssertImageMatches(t, "tabcontainer/mobile/dynamic_appended_and_removed.png", c.Capture())
	...
	test.AssertImageMatches(t, "tabcontainer/mobile/dynamic_appended_another_three.png", c.Capture())
...
func TestTabContainer_HoverButtons(t *testing.T) {
	...
	test.AssertImageMatches(t, "tabcontainer/mobile/two_first_hovered.png", c.Capture())

	test.MoveMouse(c, fyne.NewPos(75, 10))
	test.AssertImageMatches(t, "tabcontainer/mobile/two_second_hovered.png", c.Capture())
...
func TestTabContainer_Tapped(t *testing.T) {
	...
	test.AssertImageMatches(t, "tabcontainer/mobile/three_initial.png", c.Capture())
